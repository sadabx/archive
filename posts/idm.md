...
1. Download the activation file [here](https://github.com/sadabx/archive/releases/download/idm_1.0/IDM_Activation.cmd).
...
> 💡 Disable the IDM update check, download the **[something.reg](https://github.com/sadabx/archive/releases/download/idm_1.0/something.reg)** and run the file, and you're all set.
